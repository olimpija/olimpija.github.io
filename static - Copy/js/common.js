! function (e) {
    ...
    ! function (t, n) {
        ...
        var we = function (e) {
            ...
            var _, b, E, T, w, C, x, A, S, D, O, I, N, L, k, H, P, j, R, W = "sizzle" + 1 * new Date,
                M = e.document,
                F = 0,
                B = 0,
                U = n(),
            ...
            b = t.support = {}, w = t.isXML = function (e) {
                ...
                return i !== N && 9 === i.nodeType && i.documentElement ? (N = i, L = N.documentElement, k = !w(N), M !== N && (n = N.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ee, !1) : n.attachEvent && n.attachEvent("onunload", Ee)), b.attributes = r(function (e) {
                ...
                }, P = [], H = [], (b.qsa = he.test(N.querySelectorAll)) && (r(function (e) {
                    ...
                    b.disconnectedMatch = j.call(e, "*"), j.call(e, "[s!='']:x"), P.push("!=", ie)
                }), H = H.length && new RegExp(H.join("|")), P = P.length && new RegExp(P.join("|")), t = he.test(L.compareDocumentPosition), R = t || he.test(L.contains) ? function (e, t) {
                ...
                if ((e.ownerDocument || e) !== N && I(e), n = n.replace(le, "='$1']"), b.matchesSelector && k && !V[n + " "] && (!P || !P.test(n)) && (!H || !H.test(n))) try {
                    var i = j.call(e, n);
    ...
    Object.defineProperty(t, "__esModule", {
        ...
        function (e) {
            function t(e) {
                if (ga) {
                    var t = o;
                    "" !== e && (t += "#" + e), ga("set", "page", t), ga("send", "pageview")
                }
            }
            var i = n(0),
                r = (n.n(i), n(1), n(5)),
                o = (n.n(r), window.location.pathname),
                s = e("body").scrollspy().data()["bs.scrollspy"],
                a = "";
            a += "#sectionTagline,#sectionMission,#sectionBuild,#sectionTeam,#sectionResearch,#sectionInvestors,#sectionAngelInvestors,#sectionContact,", a += "#sectionSummary,#sectionSplitBuild,#sectionUseCases,#sectionHowItWorks,#sectionBenefits,#sectionContact,", a += "#sectionJobs,#sectionContact";
            var l = e.makeArray(e(a)),
                u = [];
            l.map(function (t) {
                t && u.push(e(t).offset().top)
            }), s._targets = l, s._offsets = u, e(window).on("activate.bs.scrollspy", function (n, i) {
                if (i && i.relatedTarget) {
                    t(e(i.relatedTarget).attr("id"))
                }
            }), e(".content-member").on("mouseenter", function () {
                e(".content-over", this).slideDown()
            }), e(".content-member").on("mouseleave", function () {
                e(".content-over", this).slideUp()
            }), e(".content-investor").on("mouseenter", function () {
                e(".content-over", this).slideDown()
            }), e(".content-investor").on("mouseleave", function () {
                e(".content-over", this).slideUp()
            })
        }.call(t, n(0))
}, function (e, t) {
